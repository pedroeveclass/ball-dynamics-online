...
export function ManagerStadiumIntroTour({ enabled }: Props) {
  const { t } = useTranslation('tour');
  const { shouldRun, markSeen } = useLocalTour('manager_stadium_intro');
  ...
  const steps: Step[] = [
    { target: '[data-tour="stadium-header"]', content: renderStep('manager_stadium_intro.step1.title', 'manager_stadium_intro.step1.body'), placement: 'bottom', skipBeacon: true },
    { target: '[data-tour="stadium-sectors"]', content: renderStep('manager_stadium_intro.step2.title', 'manager_stadium_intro.step2.body'), placement: 'top', skipBeacon: true },
    { target: '[data-tour="stadium-style"]', content: renderStep('manager_stadium_intro.step3.title', 'manager_stadium_intro.step3.body'), placement: 'top', skipBeacon: true },
  ];
