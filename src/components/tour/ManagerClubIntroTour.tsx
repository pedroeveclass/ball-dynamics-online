...
export function ManagerClubIntroTour({ enabled }: Props) {
  const { t } = useTranslation('tour');
  const { shouldRun, markSeen } = useLocalTour('manager_club_intro');
  ...
  const steps: Step[] = [
    { target: '[data-tour="manager-club-header"]', content: renderStep('manager_club_intro.step1.title', 'manager_club_intro.step1.body'), placement: 'bottom', skipBeacon: true },
    { target: '[data-tour="manager-club-shortcuts"]', content: renderStep('manager_club_intro.step2.title', 'manager_club_intro.step2.body'), placement: 'bottom', skipBeacon: true },
    { target: '[data-tour="manager-club-extras"]', content: renderStep('manager_club_intro.step3.title', 'manager_club_intro.step3.body'), placement: 'top', skipBeacon: true },
  ];
