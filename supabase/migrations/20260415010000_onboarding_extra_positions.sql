-- ═══════════════════════════════════════════════════════════
-- Onboarding: expand accepted positions.
--
-- The previous create_player_profile only accepted the 10 "classic"
-- positions. The client now offers 16 (CDM, CF, LM, RM, LWB, RWB
-- added), which already are supported elsewhere in the system
-- (formations, positional penalty, engine groups). Update the
-- validation list and add matching base boosts.
-- ═══════════════════════════════════════════════════════════
